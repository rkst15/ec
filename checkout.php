	...
	<div id="page">
		...
		<div class="colorlib-product">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-8">
						<form method="post" class="colorlib-form" action="orderAction.php">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="form-field">
											...
											<select name="address" id="people" class="form-control">
								...
								<div class="cart-detail">
									...
									<ul>
										<li>
											<ul>
												...
												foreach ($result as $key => $row) {
													...
													$sum = $price * $quantity;
													$subtotal += $sum;
													echo "<li><span>" . $quantity . " x " .  $name . "</span> <span> PHP " . $price . "</span></li>";
												}
											?>
										...
										<li><span>Subtotal</span> <span>PHP
												<?php echo $subtotal; ?></span></li>
										<li><span>Shipping</span> <span>$0.00</span></li>
										<li><span>Order Total</span> <span>PHP
												<?php $total = $subtotal + 0; echo $total; ?></span></li>
									</ul>
								</div>
							</div>
