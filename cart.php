				...
				<div class="row row-pb-lg">
					<div class="col-md-12">
                        ...
                        foreach ($result as $key => $row) {
                            ...
                            echo "<div class='product-img' style='background-image: url(images/item-6.jpg)'>";
                            echo "</div>";
                            ...
                            echo "<div class='one-eight text-center'>";
                            echo "<div class ='display-tc'>";
                            echo "<span class='price'>" . $quantity . "</span>";
                            echo "</div>";
                            echo "</div>";
                            echo "<div class='one-eight text-center'>";
                            echo "<div class ='display-tc'>";
                            echo "<span class='price'>php " . $sum . "</span>";
                            echo "</div>";
                            echo "</div>";
                            echo "<div class='one-eight text-center'>";
								...
								<div class="col-sm-4 text-center">
									<div class="total">
										<div class="sub">
											...
											$total = $subtotal + 0;
											echo "<p><span><strong>Total:</strong></span> <span>PHP " . $total . "</span></p>";
											echo "</div>";
										?>
