				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-5 col-md-3">
							...
							<div id="colorlib-logo" class="text-right"><a href="logout.php" class="btn btn-outline-danger text-right">Log out</a></div>
						</div>
					</div>
					<div class="row">
				...
				<div class="row row-pb-md">
					<?php
                        foreach ($result as $key => $row) {
                            ...
                            echo "<a href='product-detail.php?id=$id'class='prod-img'>";
                            echo "<img src='images/item-1.jpg' class='img-fluid' alt='Free html5 bootstrap 4 template'>";
                            echo "</a>";
                            echo "<div class='desc'>";
                            echo "<h2><a href='product-detail.php?id=$id'>" . $name . "</a></h2>";
                            echo "<span class='price'>php " . $price . "</span>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        }
