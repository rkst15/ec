...
<body>
    <div class="container">
        <form class="form-horizontal" role="form" method="post" action="productAction.php" enctype="multipart/form-data">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                            <input type="number" name="productprice" class="form-control" id="name" placeholder="100"
                                required autofocus>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            <div class="input-group-addon" style="width: 2.6rem"><i class="fa fa-user"></i></div>
                            <input type="file" name="image" class="form-control" id="name" placeholder=""
                                required autofocus>
                        </div>
                    </div>
                </div>
