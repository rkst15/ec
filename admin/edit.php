                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <input type="text" name="newuser" class="form-control" id="name" value="<?php echo $username; ?>"
                                required autofocus>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <input type="email" name="newemail" class="form-control" id="email" value="<?php echo $email; ?>"
                                required autofocus>
                        </div>
                    </div>
                </div>
